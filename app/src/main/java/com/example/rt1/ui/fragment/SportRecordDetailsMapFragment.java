...
import com.example.rt1.sport_motion.TraceRePlay;
...
//        aMap.setMyLocationType(AMap.MAP_TYPE_NORMAL);  // 设置定位的类型
    ...
    private final LocationSource MyLocationSource = new LocationSource() {
    ...
    //定位成功
    private final AMapLocationListener MyAMapLocationListener = new AMapLocationListener() {
        @Override
