package com.ironsublimate.RouteRecorder.sport_motion;
...
import com.ironsublimate.RouteRecorder.sport_motion.servicecode.RecordService;
import com.ironsublimate.RouteRecorder.sport_motion.servicecode.impl.RecordServiceImpl;
...
//    private List<LatLng> mSportLatLngs = new LinkedList<>();
    ...
    private void initLocationOption() {
        ...
        AMapLocationClientOption mOption = new AMapLocationClientOption()
                ...
                .setGpsFirst(true)//可选，设置是否gps优先，只在高精度模式下有效。默认关闭
                .setHttpTimeOut(30000)//可选，设置网络请求超时时间。默认为30秒。在仅设备模式下无效
                .setInterval(4000)//可选，设置定位间隔。默认为2秒
                .setNeedAddress(true)//可选，设置是否返回逆地理地址信息。默认是true
                ...
                .setLocationCacheEnable(false) //可选，设置是否使用缓存定位，默认为true
                .setGeoLanguage(AMapLocationClientOption.GeoLanguage.DEFAULT);//可选，设置逆地理信息的语言，默认值为默认语言（根据所在地区选择语言）
